...
if(NOT (TARGET STM32::Rdimon))
    add_library(STM32::Rdimon INTERFACE IMPORTED)
    target_compile_options(STM32::Rdimon INTERFACE $<$<C_COMPILER_ID:GNU>:--specs=rdimon.specs>)
    target_link_options(STM32::Rdimon INTERFACE $<$<C_COMPILER_ID:GNU>:--specs=rdimon.specs>)
endif()
